...
public class DestinationRepository {
    ...
    // The maximum Levenshtein distance that two destination names may have and still
    ...
    /**
     * Changes any references in TripData of any similar destinations that are going to be merged to
     * the id of the destination that they have been merged to. I.e if there are 3 Eiffel towers,
     ...
     *
     * @param userId ID of user who is changing the destination to public (i.e forcing a merge to
     * happen)
    ...
    public List<Destination> getSimilarDestinations(Destination destination) {
        return ebeanServer.find(Destination.class)
            // Add where clause to make sure longitudes
            // are the same (to specified number of decimal places)
            ...
            // Add where clause to make sure latitudes are
            // the same (to specified number of decimal places)

...
public class ProfileController extends Controller {
    ...
    public ProfileController(FormFactory formFactory, MessagesApi messagesApi) {
        ...
        this.profiles = com.google.common.collect.Lists.newArrayList(
                new models.Profile(time, "Claudia", "Rachel", "Field", "Female", LocalDate.of(1998, 1, 10), nationalities, passports, travelerTypes),
                new models.Profile(time, "Jane", null, "Doe", "Female", LocalDate.of(1995, 3, 8), nationalities, passports, travelerTypes)
                );
    }
